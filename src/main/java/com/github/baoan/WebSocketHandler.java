...
import com.github.baoan.msg.WebSocketMsg;
import com.github.baoan.msg.WebSocketPingMsg;
import com.github.baoan.msg.WebSocketTextMsg;
import com.github.baoan.server.WebSocketAuthServer;
...
public class WebSocketHandler extends TextWebSocketHandler implements WebSocketMsgEndpoint {
    ...
    private WebSocketAuthServer webSocketAuthServer;
    ...
    @Autowired
    public void setWebSocketAuthServer(WebSocketAuthServer webSocketAuthServer) {
